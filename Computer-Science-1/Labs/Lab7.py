# CS1210: Lab7 [3 functions that code and decode]
######################################################################
...
#
def signed():
    return(["bmcano","bgerhardt","yjin39","icheville"])

######################################################################
# SPECIAL NOTE: Back by popular demand is Lab6!
#
# Many of you had problems with the indexing in syllables(), so I
# though after our review of the pivoting code in quick sort you might
# have a better chace at it.
#
# This also gives those affected by Internet outages last week another
# chance at this lab. When grading, I will count the two Lab6's as a
# single lab, taking the max of your two scores. 
#
# As a final hint, for a successful encode()/decode() experience,
# stick to ubs that do not contain u, y, w, g, or q.
#
######################################################################
...
# believe, if the "ub" you have chosen is itself a legal syllable, and
# does not rely on "ambiguous" vowels like 'u' or 'y': in this case,
# 'ab' is a better ub than 'ub'.
#
